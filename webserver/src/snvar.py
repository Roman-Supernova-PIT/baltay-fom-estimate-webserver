...
def snvar( inparams ):
    ...
    try:
        ...
        d = scipy.integrate.quad(dfn, botc, topc, args=(u, v, om, q))[0]
        sigd=0.002*d # 0.2% precision on shift parameter d(=R)

        ddo = scipy.integrate.quad(ddofn, botc, topc, args=(u, v, om, q))[0]
        ddw0 = scipy.integrate.quad(ddw0fn, botc, topc, args=(u, v, om, q))[0]
        ddwa = scipy.integrate.quad(ddwafn, botc, topc, args=(u, v, om, q))[0]
        ddo = 0.5/om/om*ddo
        ddw0 = -1.5*q/om*ddw0
        ddwa = -1.5*q/om*ddwa
        ...
        for i in range(20):
            ...
            top = y
            ansr = scipy.integrate.quad(fnr, bot, top, args=(u, v, om, q))[0]
            ansdo = scipy.integrate.quad(fndo, bot, top, args=(u, v, om, q))[0]
            ansdu = scipy.integrate.quad(fndu, bot, top, args=(u, v, om, q))[0]
            ansdv = scipy.integrate.quad(fndv, bot, top, args=(u, v, om, q))[0]
